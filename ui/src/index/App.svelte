...
<div style="
    ...
    <div class="col" style="justify-content: center; gap: 16px;">
        ...
        <p style="text-align: center; font-size: 1.4rem; line-height: 1.8rem; font-weight: bold; font-style: italic; color: var(--gray-300);">Take speedcubing to the next level</p>
    </div>
    <div class="col" style="box-shadow: 0 0 4px 2px var(--gray-600);
    border-radius: 16px; padding-bottom: 16px; margin: 16px 32px;">
